...
Channel.py - This is the code to simulate the prroperties of the channel such as data and ack error. 
servsend.jpg - The image that is sent by the server to the client.

Setup
Create a folder(directory) in your PC and name it(say 'phase3').
